		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Indus Print QR Code",
									"targetURL": "#zoprintqrzoprintqr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zoprintqrzoprintqr-display": {
								"semanticObject": "zoprintqrzoprintqr",
								"action": "display",
								"description": "Generate QR for Production Order",
								"title": "Indus Print QR Code",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zoprintqr.zoprintqr",
									"url": sap.ui.require.toUrl("zoprintqr/zoprintqr")
								}
							}
						}
					}
