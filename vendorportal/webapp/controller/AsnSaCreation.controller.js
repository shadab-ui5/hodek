    ...
    return Controller.extend("hodek.vendorportal.controller.AsnSaCreation", {
        ...
        onNavBack: function () {
            ...
            if (sPreviousHash !== undefined) {
                ...
                this.getOwnerComponent().getRouter().navTo("RouteScheduleAgreeOrder", {
        ...
        onChangeRAPOItemQuantity: function (oEvent) {
            ...
            let orderQuantity = parseFloat(oItem.TargetQuantity) || 0;
        ...
        onSave: function () {
            ...
            MessageBox.confirm("Are you sure you want to save this ASN?", {
                ...
                onClose: function (oAction) {
                    ...
                    var itemData = [];
                    that.getView().byId("idTable_RAPO").getModel("AsnSaItemsModel").getProperty("/Results").filter(item => {
                    ...
                    that.inGateEntryModel.create("/InwardGateHeader", payload, {
                        ...
                        success: function (oData, oResponse) {
                            ...
                            var aPostPromises = aItems.map(function (oItem) {
                                return Models.updateforItems(that, oItem, "ItemforSchAgr"); // must return a Promise
                            });
